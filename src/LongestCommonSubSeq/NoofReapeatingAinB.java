...
public class NoofReapeatingAinB {
    private static int ReapeatingAinB(String a, String b, int l, int m){
        ...
        // the same aaplies to m=0, that means all the characters in 'm' are iterated since we decrease 'm' only if there a equal character in 'l'. therfore return 1 when m==0;
